...
},{}],"src/utils/loader.js":[function(require,module,exports) {
"use strict";
...
function _default(container) {
  ...
  return function () {
    var nextMarkup = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
var _default = {
  ...
  BY_BREED: function BY_BREED(breed) {
    return "breed/".concat(breed, "/images");
  },
  SUBBREED_LIST: function SUBBREED_LIST(breed) {
    return "breed/".concat(breed, "/list");
  },
  SUBBREED: function SUBBREED(breed, subbreed) {
    return "breed/".concat(breed, "/").concat(subbreed, "/images");
  }
};
exports.default = _default;
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/utils/dropdown.js":[function(require,module,exports) {
"use strict";
...
function _default() {
  var scopeComponent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  if (!scopeComponent) scopeComponent = document;
  scopeComponent.querySelectorAll("[data-dropdown]").forEach(function (el) {
    return el.addEventListener("click", function (e) {
      e.currentTarget.querySelectorAll("[data-list]").forEach(function (listEl) {
...
},{}],"src/view/BreedItems.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderBreedItemElements = renderBreedItemElements;
exports.default = BreedItems;

var _dropdown = _interopRequireDefault(require("../utils/dropdown"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function renderBreedItemElements(breed) {
  var subBreeds = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var subBreed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var markup =
  /* html */
  "\n          <li ".concat(subBreeds.length > 0 ? "data-dropdown" : "", "><a href=\"/#/breed?breed=").concat(breed).concat(subBreed ? "&subbreed=".concat(subBreed) : "", "\">").concat(subBreed ? subBreed : breed, "</a>\n              ").concat(subBreeds.length > 0 ? "<ul data-list style='display: none;'>" + subBreeds.map(function (sub) {
    return renderBreedItemElements(breed, false, sub);
  }).join("") + "</ul>" : "", "\n          </li>\n      ");
  return markup;
}

function BreedItems(breedItems) {
  var containerToAppend = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var markup =
  /* html */
  "<ul>\n    ".concat(Object.keys(breedItems).map(function (key) {
    return renderBreedItemElements(key, breedItems[key]);
  }).join(""), "\n  </ul>");

  if (containerToAppend) {
    containerToAppend.insertAdjacentHTML("afterbegin", markup);
    (0, _dropdown.default)(containerToAppend);
    containerToAppend.querySelectorAll('li:not([data-dropdown])').forEach(function (el) {
      return el.addEventListener('click', function (e) {
...
},{"../utils/dropdown":"src/utils/dropdown.js"}],"node_modules/ssr-window/ssr-window.esm.js":[function(require,module,exports) {
"use strict";
...
},{"./bundle-url":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/swiper/swiper-bundle.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/view/SwiperContainer.js":[function(require,module,exports) {
"use strict";
...
exports.default = SwiperContainer;
...
},{"swiper":"node_modules/swiper/swiper.esm.js","swiper/swiper-bundle.css":"node_modules/swiper/swiper-bundle.css"}],"src/routes/home.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.HomePageSidebar = HomePageSidebar;
...
var _BreedItems = _interopRequireDefault(require("../view/BreedItems"));

var _SwiperContainer = _interopRequireDefault(require("../view/SwiperContainer"));
...
var content = _elements.default.content,
    sidebar = _elements.default.sidebar;
var API_HOST = _api.default.API_HOST,
    ALL_BREEDS = _api.default.ALL_BREEDS,
    RANDOM_IMAGE = _api.default.RANDOM_IMAGE;

function HomePageSidebar() {
  return _HomePageSidebar.apply(this, arguments);
}

function _HomePageSidebar() {
  _HomePageSidebar = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var clearSidebarLoader, _yield$axios, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            clearSidebarLoader = (0, _loader.default)(sidebar);
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)(API_HOST + ALL_BREEDS);
          ...
          case 4:
            ...
            if (data.message) {
              clearSidebarLoader();
              (0, _BreedItems.default)(data.message, sidebar);
            }
...
function HomePageContent() {
  return _HomePageContent.apply(this, arguments);
}

function _HomePageContent() {
  _HomePageContent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var clearContentLoader, _yield$axios2, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            clearContentLoader = (0, _loader.default)(content);
            _context2.prev = 1;
            _context2.next = 4;
            return (0, _axios.default)(API_HOST + RANDOM_IMAGE + "/10");
          ...
          case 4:
            ...
            if (data.message) {
              clearContentLoader();
              (0, _SwiperContainer.default)(data.message, content);
            }
...
},{"../elements":"src/elements.js","../utils/loader":"src/utils/loader.js","../api":"src/api.js","axios":"node_modules/axios/index.js","../view/BreedItems":"src/view/BreedItems.js","../view/SwiperContainer":"src/view/SwiperContainer.js"}],"src/view/Polaroids.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderPolaroids = renderPolaroids;
exports.default = Polaroids;

function renderPolaroids(urls) {
  return urls.map(function (url) {
    return (
      /* html */
      "\n\t\t<figure class=\"polaroid-list__fig\">\n\t\t\t<img loading=\"lazy\" src=\"".concat(url, "\" alt=\"dogo sexy pic\" />\n\t\t</figure>\n\t")
    );
  }).join("");
}

function Polaroids(urls) {
  var containerToAppend = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var markup =
  /* html */
  "\n\t\t<ul class=\"polaroid-list\">\n\t\t\t".concat(renderPolaroids(urls), "\n\t\t</ul>\n\t");
...
},{}],"src/routes/breeds.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = BreedPageContent;
...
var _Polaroids = _interopRequireDefault(require("../view/Polaroids"));
...
var content = _elements.default.content;
var API_HOST = _api.default.API_HOST,
    BY_BREED = _api.default.BY_BREED,
    SUBBREED = _api.default.SUBBREED;

function BreedPageContent() {
  return _BreedPageContent.apply(this, arguments);
}

function _BreedPageContent() {
  _BreedPageContent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var params,
        breed,
        subbreed,
        breedUrl,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            breed = params.breed, subbreed = params.subbreed;
            breedUrl = API_HOST;
            console.log('breeds');
            if (breed && subbreed) breedUrl += SUBBREED(breed, subbreed);else if (breed) breedUrl += BY_BREED(breed);
            clearContentLoader = (0, _loader.default)(content);
            _context.prev = 6;
            _context.next = 9;
            return (0, _axios.default)(breedUrl);
          ...
          case 9:
            ...
            if (data.message) {
              ...
              (0, _Polaroids.default)(data.message, content);
              console.log(content.childElementCount);
            }
...
},{"axios":"node_modules/axios/index.js","../api":"src/api.js","../elements":"src/elements.js","../utils/loader":"src/utils/loader.js","../view/Polaroids":"src/view/Polaroids.js"}],"src/utils/isAsync.js":[function(require,module,exports) {
"use strict";
...
var _breeds = _interopRequireDefault(require("./routes/breeds"));

var _isAsync = _interopRequireDefault(require("./utils/isAsync"));
...
var store = {};
var Router = {
  "": [_home.HomePageSidebar, _home.HomePageContent],
  "breed": [_home.HomePageSidebar, _breeds.default]
};
var secondCallPrevent = [];
["load", "hashchange"].forEach(function (event) {
  window.addEventListener(event, function () {
    ...
    if (hash.includes("?")) {
      hashParams = hash.split("?")[1].split("&").reduce(function (res, item) {
    ...
    hash = hash.split("?")[0];
    var routeHandlersArray = [];
    Object.keys(Router).forEach(function (route) {
      if (hash === route) {
        if (!_typeof(Router[route]) === "array") return;
        Router[route].forEach(function (newHandler) {
          if (routeHandlersArray.findIndex(function (handler) {
            return handler.toString() === newHandler.toString();
          }) < 0) {
    ...
    routeHandlersArray.forEach( /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(secondCallPrevent.findIndex(function (preventFunc) {
                  return preventFunc.toString() === handler.toString();
                }) >= 0)) {
                  _context.next = 3;
                  break;
                }
...
},{"./routes/home":"src/routes/home.js","./routes/breeds":"src/routes/breeds.js","./utils/isAsync":"src/utils/isAsync.js","./scss/main.scss":"src/scss/main.scss"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
